...
развёртывание `Airbyte` на WSL под управлением `Ubuntu 24.04.3 LTS (Noble Numbat)`
...
![Screeenshot](https://github.com/s-kononenko/otus-click-hw/blob/main/images/16-destination.png?raw=true)
